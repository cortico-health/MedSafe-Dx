...
* Coverage / format failure rate (missing or invalid outputs). Missing or invalid outputs count against Safety Pass Rate operationally, but are reported separately from the three clinical hard-failure subtypes above.
